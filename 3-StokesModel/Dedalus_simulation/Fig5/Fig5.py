...
Lx, Lz = 64., 64.
Nx, Nz = 1024, 1024
stop_sim_time = 9000 + 3000*restart # Stopping criteria
...
if not restart:
    ...
    write, initial_timestep = solver.load_state('/home/jms24002/stokes_flows/dedalus/fig5/checkpoints/checkpoints_s48.h5')
    max_timestep = 0.02
