...
def main(filename, start, count, output):
    ...
    with h5py.File(filename, mode='r') as file:
        ...
        plt.plot(np.array(t_list),np.array(urms))
        plt.xlabel(r'$t$')
        plt.xticks([0,max(t_list)])
        plt.tick_params(axis='x', which='both', bottom=True, top=False, labelbottom=True)# Hide xticks
        plt.tick_params(axis='y', which='both', left=True, right=False, labelleft=True)
        ...
        plt.figure(figsize=(10,2))
        plt.plot(np.array(t_list),np.array(wrms))
        plt.xlabel(r'$t$')
        plt.xticks([0,max(t_list)])
        plt.tick_params(axis='x', which='both', bottom=True, top=False, labelbottom=True)# Hide xticks
        plt.tick_params(axis='y', which='both', left=True, right=False, labelleft=True)
        ...
        plt.figure(figsize=(10,2))
        plt.plot(np.array(t_list),np.array(Trms))
        plt.xlabel(r'$t$')
        plt.xticks([0,max(t_list)])
        plt.tick_params(axis='x', which='both', bottom=True, top=False, labelbottom=True)# Hide xticks
        plt.tick_params(axis='y', which='both', left=True, right=False, labelleft=True)
        ...
        plt.figure(figsize=(10,2))
        plt.plot(np.array(t_list),np.array(Srms))
        plt.xlabel(r'$t$')
        plt.xticks([0,max(t_list)])
        plt.tick_params(axis='x', which='both', bottom=True, top=False, labelbottom=True)# Hide xticks
        plt.tick_params(axis='y', which='both', left=True, right=False, labelleft=True)
