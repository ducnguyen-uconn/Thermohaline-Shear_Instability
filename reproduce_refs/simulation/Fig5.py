...
# timestepper = d3.RK443 # 3rd-order 4-stage DIRK+ERK scheme [Ascher 1997 sec 2.8]
...
# define initial condition / load data to restart simulation
# Initial conditions
if not restart:
...
xg = xbasis.global_grid(dist, scale=1)
zg = zbasis.global_grid(dist, scale=1)
